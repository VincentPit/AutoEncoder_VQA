...
class MultiModalModel(nn.Module):
    def __init__(self, bert_model, vit_model, tokenizer, vocab_size, max_seq_length=1024):
        ...
        # Linear layer to match BERT embedding size with ViT
        self.padding = nn.ConstantPad1d((0, 1024 - 768), 0)
    ...
    def forward(self, text_input_ids, text_attention_mask, image_tensor, decoder_input_ids):
        ...
        # Pad BERT embeddings from 768 to 1024
        text_embeddings = self.padding(text_embeddings)  # Shape: [batch_size, seq_len, 1024]
