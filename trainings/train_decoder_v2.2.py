...
if __name__ == "__main__":
    ...
    # Initialize BERT and ViT models from scratch
    bert_model = BertModel(config=BertConfig())  # Initialize with a new configuration
    vit_model = prepare_model(chkpt_dir=None, arch='mae_vit_large_patch16', only_encoder=True)  # Initialize with no checkpoint
